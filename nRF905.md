...
+ 기본적인 Antenna를 사용하면 -2dBm에서 35m, -10dBm에서 40m 통신거리 확인
+ 추가적으로 Antenna를 교체하여, test시 -2dBm에서 30m, -10dBm에서 문을 나선후 연결이 끊기는 것을 확인
+ nRF905 교체후 기본적인 Antenna를 사용하면 -2dBm에서 25m, -10dBm에서 문을 나선후 연결이 끊기는 것을 확인
+ Antenna를 교체하여, test시 -2dBm에서 35m, -10dBm에서 문을 나선후 연결이 끊기는 것을 확인
+ -2dBm보다 -10dBm이 지형지물 등 장애물에 통신이 영향을 더 많이 받음
