# NRF905 Transceiver Module Test  
> ### Author: 김동욱
> ### Date: 2022.03.15.Tue
> ### Site: ㈜플루톤
...
+ 기본적인 Antenna를 사용하면 -2dBm에서 20m, -10dBm에서 40m를 동작한다. 
+ 추가적으로 Antenna를 교체하여, test시 -2dBm에서 30m, -10dBm에서는 문밖을 나가면 연결이 끊긴다.
+ 위의 2가지 중 교체한 안테나가 지형지물 등 장애물에 통신이 영향을 더 많이 받음.
